"""
One-off MongoDB content migrations that used to live under `if __name__ == "__main__"` in main.py.

They were already applied to the production database in July 2026 and are kept here only as a
record of how the content was shaped. DO NOT run this file casually: it writes to the live DB.
To run deliberately:  python scripts/db_migrations_2026.py --yes
"""
import os
import sys
...
from main import (db, projects_collection, accomplishments_collection, experiences_collection,  # noqa: E402
                  extra_curriculars_collection, insert_document, update_collection)
